...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
      <a href="#top">
         <Image src={isDarkMode ? "/mate_dark.png" : "/mate.png"} alt="My Logo" width={800} height={100}  className='w-28 cursor-pointer mr-14' />
      </a>
      ...
      <div className='flex items-center gap-4'>
        <button onClick={()=>setIsDarkMode(prev => !prev)} 
         ...
         <a href="#footer" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50'>Contact 
         <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt='contact' className='w-3' /> </a>
